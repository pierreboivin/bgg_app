...
@section('content')
    ...
    @if(\App\Helpers\Helper::ifBGGInfo())
        <div id="progression-message-warning" class="alert alert-warning" role="alert">Attendez que les données soient chargées. Cette étape peut nécessiter quelques minutes.</div>
        <div id="progression-message-success" class="alert alert-success" role="alert">Les données ont été chargées. Vous pouvez les consulter par les options ci-dessous ou par le menu.</div>
    ...
    @else
        <div class="alert alert-warning">
            Vous n'avez pas accès aux informations de BGG puisqu'il n'y a pas de compte BGG associé à votre utilisateur.
        </div>
    @endif
